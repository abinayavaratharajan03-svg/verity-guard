...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:title", content: "Deepfake Auditor — Real-Time Video Deception & Deepfake Detection" },
      { name: "twitter:description", content: "AI-Powered Deepfake Detection & Identity Verification Platform. Detect synthetic media, voice cloning, and KYC fraud in real time." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/933c2ac2-6726-4018-8a9d-be04374e5592" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/933c2ac2-6726-4018-8a9d-be04374e5592" },
    ],
    links: [
